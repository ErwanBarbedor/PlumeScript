...
-- Main execution flow
local tests = loadTests("block convert errors eval if files loops lua macros macros_syntax_error macros_vararg std suggestions table text variables issues")
